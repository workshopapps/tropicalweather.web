...
var TransactionService = function () {
  ...
  _proto.adjustTransactionTime = function adjustTransactionTime(transaction) {
    ...
    if (transaction.type === _constants.PAGE_LOAD) {
      var transactionEndWithoutDelay = transaction._end - _constants.PAGE_LOAD_DELAY;
      var lcp = _metrics.metrics.lcp || 0;
      var latestXHRSpan = (0, _utils.getLatestXHRSpan)(spans) || {};
