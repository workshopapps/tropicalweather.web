  ...
  return (
    <div className="bg-[#2B2A30] pb-16 w-full pr-4">
      ...
      <div className="flex flex-col md:flex-row justify-center md:justify-around mb-4 ml-4 md:ml-4 lg:ml-4">
        <div className="WeatherIndustryCard space-y-6 max-w-full py-8">
          <p className="text-white font-bold text-4xl mt-7 ml-0">Manufacturing</p>
        ...
        <div className="WeatherIndustryCard space-y-10 mt-4 md:mt-0 mb-4 md:mb-0 ml-0 md:ml-4 lg:ml-4 mr-0 md:mr-4 lg:mr-4 py-6 max-w-full">
