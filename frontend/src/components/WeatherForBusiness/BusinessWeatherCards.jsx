...
export default function BusinessWeatherCards() {
  return (
    <div className="container mx-auto mb-24 ml-0 md:ml-48 lg:ml-8 px-16">
      <div className="flex flex-col md:flex-row space-x-0 md:space-x-6  ">
        ...
        <div className="customCard flex flex-col justify-center align-center items-center w-full h-full space-y-12 pt-8 pb-16 md:pb-8 lg:pb-16">
