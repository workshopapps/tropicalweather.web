export default function BusinessWeatherProducts() {
  return (
    <div className="bg-[#2B2A30] p-5 weatheryBusinessProducts">
      <div>
      ...
      <div className="flex flex-col md:flex-row justify-center md:justify-around align-center items-center">
        <div className="justify-center flex flex-col mr-0 md:mr-10 ">
        ...
        <div className="justify-center flex flex-col mr-0 md:mr-10 mt-8 md:mt-0">
