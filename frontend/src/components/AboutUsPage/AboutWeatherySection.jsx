...
function AboutWeatherySection() {
  ...
  return (
    <div className="container mx-auto font-Outfit">
      <h2 className="text-[var(--accents-7)] font-bold text-2xl md:text-6xl text-center py-10">{t('abouttropicalweather')}</h2>
      <p className="text-[var(--accents-6)] font-normal text-base md:text-2xl">{t('abouttropicalweatherbody')}</p>
