...
function WhyWeatherSection() {
  return (
    <div className="container flex flex-col-reverse items-center mx-0 md:mx-auto lg:flex-row md:gap-12 lg:mt-28 font-Outfit">
      <div className="flex flex-col  flex-1 lg:items-start sm:items-center">
        <p className="mb-6 text-2xl font-bold leading-5 tracking-wide text-left md:text-3xl md:text-start">Why Tropical Weather?</p>
