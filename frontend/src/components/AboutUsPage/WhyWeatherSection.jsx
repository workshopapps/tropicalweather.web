  ...
  return (
    <div className="container flex flex-col-reverse items-center mx-4 md:mx-auto lg:flex-row md:gap-12 mt-14 lg:mt-28 font-Outfit">
      <div className="flex flex-col items-center flex-1 lg:items-start">
        <h2 className="mb-6 text-2xl font-bold leading-5 tracking-wide text-center md:text-3xl md:text-start">Why Weathery?</h2>
        ...
        <div className="flex justify-between gap-8">
          <div>
            <h3 className="text-[#2B2A30] font-bold text-2xl md:text-4xl">100+</h3>
            <p className="text-[#82808F] text-xs md:text-base">Forecast models</p>
          </div>
          <div>
            <h3 className="text-[#2B2A30] font-bold text-2xl md:text-4xl">500K+</h3>
            <p className="text-[#82808F] text-xs md:text-base">Locations</p>
          </div>
          <div>
            <h3 className="text-[#2B2A30] font-bold text-2xl md:text-4xl">10K+</h3>
