      ...
      <div className="homepg-worldforecast">
        ...
        <ul className="homepg-worldul">
          ...
          <div className="homepg-worldtwo">
            <li className="homepg-poplis">
              <div className="homepg-popflex">
                <img src="/Home/Germany.svg" alt="Germany flag" />
            ...
            <li className="homepg-poplis">
              <div className="homepg-popflex">
                <img src="/Home/SouthAfrica.svg" alt="SouthAfrica flag" />
                <span>RSA SOUTHAFRICA</span>
              </div>
            ...
            <li className="homepg-poplis">
              <div className="homepg-popflex">
                <img src="/Home/Jamaica.svg" alt="Jamaica flag" />
            ...
            <li className="homepg-poplis">
              <div className="homepg-popflex">
                <img src="/Home/Scotland.svg" alt="Scotland flag" />
          ...
          <div className="homepg-worldthird">
            <li className="homepg-poplis">
              <div className="homepg-popflex">
